...
import { ArrowRight, Calendar, User, Share2, Printer, ChevronLeft, Info, CalendarDays } from "lucide-react";
...
export default function NewsDetailsPage({ params }: { params: { slug: string } }) {
    ...
    return (
        <div className="bg-[#f9f7f2] min-h-screen flex flex-col font-naskh">
            <Header />
            ...
            <main className="flex-grow w-full max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <article className="w-full lg:w-2/3 flex flex-col">
                        ...
                        {/* Breadcrumbs */}
                        <div className="flex flex-wrap items-center gap-2 mb-6 text-sm text-gray-500 font-body">
                            ...
                            <ChevronLeft className="w-4 h-4 text-gray-400" />
                            <span className="text-gray-800 font-semibold truncate max-w-[200px]">{article.title}</span>
                        </div>

                        {/* Headline */}
                        <h1 className="font-display text-3xl md:text-4xl lg:text-[42px] font-bold text-[#111811] leading-tight mb-4">
                            {article.title}
                        </h1>

                        {/* Meta Data */}
                        <div className="flex flex-wrap items-center gap-4 md:gap-6 pb-6 border-b border-[#e5e7eb] mb-8 font-body">
                            ...
                            <div className="flex items-center gap-2 text-gray-600 mr-auto lg:mr-0">
                        ...
                        {/* Featured Image */}
                        <div className="bg-white p-2 border border-[#e5e7eb] rounded-lg shadow-sm mb-8">
                            ...
                            <div className="pt-3 pb-1 px-2">
                                <p className="text-gray-500 text-sm leading-relaxed border-r-2 border-primary pr-3 font-naskh">
                        ...
                        {/* Article Body */}
                        <div
                            className="prose prose-lg max-w-none font-naskh text-gray-800"
                            dangerouslySetInnerHTML={{ __html: article.content }}
                        />

                        {/* Tags */}
                        <div className="flex flex-wrap gap-2 mt-8 pt-6 border-t border-[#e5e7eb] font-body">
                            <span className="px-3 py-1 bg-[#f0f4f0] text-gray-600 rounded-full text-sm font-medium hover:bg-primary/10 hover:text-primary transition-colors cursor-pointer">#ملتقى_الرياض</span>
                            <span className="px-3 py-1 bg-[#f0f4f0] text-gray-600 rounded-full text-sm font-medium hover:bg-primary/10 hover:text-primary transition-colors cursor-pointer">#صلة_الرحم</span>
                            <span className="px-3 py-1 bg-[#f0f4f0] text-gray-600 rounded-full text-sm font-medium hover:bg-primary/10 hover:text-primary transition-colors cursor-pointer">#أخبار_العائلة_2024</span>
                        </div>
                    ...
                    <aside className="w-full lg:w-1/3 flex flex-col gap-8">
                        ...
                        {/* Latest News Widget */}
                        <div className="bg-white rounded-xl shadow-sm border border-[#e5e7eb] overflow-hidden p-6 font-body">
                            <div className="flex items-center justify-between mb-6 border-b border-[#f0f4f0] pb-4">
                                <h3 className="font-display text-xl font-bold text-accent">آخر الأخبار</h3>
                            ...
                            <div className="flex flex-col gap-6">
                                ...
                                <Link className="group flex gap-4 items-start" href="#">
                                    ...
                                    <div className="flex flex-col pt-0.5">
                                        ...
                                        <h4 className="font-display font-bold text-gray-800 text-sm leading-tight group-hover:text-primary transition-colors">
                                            حصول الدكتور خالد بن سعيد على درجة الدكتوراه
                                        </h4>
                                        <span className="text-xs text-gray-400 mt-2">منذ يومين</span>
                                    </div>
                                </Link>
                                {/* Item 2 */}
                                <Link className="group flex gap-4 items-start" href="#">
                                    ...
                                    <div className="flex flex-col pt-0.5">
                                        ...
                                        <span className="text-xs text-gray-400 mt-2">منذ أسبوع</span>
                                    </div>
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="bg-primary/5 rounded-xl border border-primary/20 p-6 font-body">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="font-display text-lg font-bold text-accent">تنويه هام</h3>
                            </div>
